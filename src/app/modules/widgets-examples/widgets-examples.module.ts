...
import { imageImportModule } from 'src/app/pages/image_import/image_import.module';
...
@NgModule({
    ...
    imports: [CommonModule, WidgetsExamplesRoutingModule, WidgetsModule, imageImportModule, SharedModule]
})
